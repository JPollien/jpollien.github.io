...
function About() {
  return (
    <section style={{ maxWidth: '800px', margin: '2rem auto' }}>
      <h1>About Downeast Landscape Imaging</h1>
      <p>
        Downeast Landscape Imaging is a Maine-based team of drone enthusiasts
        and mapping experts with a commitment to delivering high-quality
        photogrammetry and terrain modeling services.
      </p>
      ...
      <h2>Why Choose Us</h2>
      <ul>
        <li>Accurate, High-Resolution Mapping Data</li>
        <li>Local Knowledge of Maine’s Unique Geography</li>
        <li>Rapid Turnaround Times and On-Site Scanning</li>
        <li>Dedicated Customer Support for Post-Processing & Reporting</li>
      </ul>
    </section>
  );
}
